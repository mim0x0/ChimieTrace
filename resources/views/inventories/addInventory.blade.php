...
<div class="container my-5">
    <form action="/i/addInventory/{{$inventory->id}}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end pt-3">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary px-4 shadow-sm">
                        <i class="bi bi-plus-circle me-2"></i> Topup Container
                    </button>
                </div>
            </div>
        </div>
