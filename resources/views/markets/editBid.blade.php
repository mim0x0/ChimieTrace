...
<div class="container">
    ...
    <form action="{{ url('/m/'.$bids->id.'/bid') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        @method('PATCH')
        ...
        <div class="card shadow-lg border-0">
            <div class="card-body">
                ...
                <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-md-9">
                        <input id="notes" type="text" name="notes"
                            ...
                            value="{{ old('notes') ?? $bids->notes }}" autofocus>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end pt-3">
                    <div class="mx-2">
                        <a href="{{ route('market.detail', $bids->market->id) }}" class="btn btn-lg btn-secondary px-4 shadow-sm">Back</a>
                    </div>
                    <button type="submit" class="btn btn-lg btn-primary px-4 shadow-sm">
                        <i class="bi bi-plus-circle me-2"></i> Edit Offer
                    </button>
                </div>
